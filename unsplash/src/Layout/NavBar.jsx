...
const NavBar = () => {
  return (
    <>
      <div className="flex px-6 justify-between item-center ">
        ...
        <div className="flex justify-between items-center w-[25%] tex-sm px-6 ">
          <h1 className="font-bold">Get Unplash+</h1>
          <p className="text-gray-600 font-medium">Log in</p>
          <button className="border bor-gra-300 p-1 rounded-md text-gray-700 font-medium shadow-2xl ">
            Submit an iamge
          </button>
        </div>
      </div>
